                                    ...
                                    {% else %}
                                        ...
                                        <td>
                                            {% if result.link %}
                                                ...
                                                <a href="/view?url={{ result.link|urlencode }}" class="btn btn-sm btn-outline-secondary">Voir dans l'application</a>
                                            {% else %}
...
if __name__ == '__main__':
    # Exécuter l'application sur le port 5003 pour éviter les conflits
