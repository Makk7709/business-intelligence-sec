                        ...
                        <form id="compareForm" class="mb-4">
                            <div class="row g-3">
                                <div class="col-md-5">
                                    ...
                                    <input type="text" class="form-control" id="symbol1" placeholder="ex: AAPL" required>
                                </div>
                                <div class="col-md-5">
                                    <label for="symbol2" class="form-label">Deuxième titre</label>
                                    <input type="text" class="form-control" id="symbol2" placeholder="ex: MSFT" required>
                                </div>
                                <div class="col-md-2 d-flex align-items-end">
                                    <button type="submit" class="btn btn-primary w-100">
                                        <i class="bi bi-bar-chart-fill me-1"></i> Comparer
                                    </button>
                                </div>
                            </div>
                        </form>
